void setup() {
  PImage friends = loadImage("5 seconds of dwebs.jpeg");  // 2. Change this to match the name of your photo. 
  ...
  mustache = loadImage("mustache.jpeg"); // 5. Change this to match your file name.
}
